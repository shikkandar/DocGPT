...
appRouter.post("/verifyOTP/:otp", getUserFromToken, verifyOTP);
appRouter.post("/upload/:chatID", getUserFromToken, upload.single('document'), uploadMiddleware, pdfDataExtractor, userController.uploadFile);
